    ...
    try {
        await prisma.promotion.create({
            data: {
                ...
                efficiency_grade: formData.get('efficiency_grade') ? Number(formData.get('efficiency_grade')) : null,
                raise_percentage: formData.get('raise_percentage') ? Number(formData.get('raise_percentage')) : null,
                raise_amount: formData.get('raise_amount') ? Number(formData.get('raise_amount')) : null,
