...
export default async function SalaryCeilingsPage() {
    const items = await prisma.salaryCeiling.findMany({
    ...
    return (
        <div className="p-6 md:p-10 font-cairo bg-gray-50/30 min-h-screen" dir="rtl">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    <div className="flex items-center gap-2 text-sm text-gray-400 mb-2 font-medium">
                        ...
                        <span>/</span>
                        <span className="text-gray-600">سقوف الأجور</span>
                    </div>
                    <h1 className="text-3xl font-bold text-gray-900 tracking-tight">سقوف الأجور</h1>
                </div>
            ...
            <div className="max-w-4xl mx-auto">
                <AddItemForm jobCategories={jobCategories} />
                    ...
                    <table className="w-full text-right">
                        <thead className="bg-gray-50/80 text-gray-500 text-xs uppercase tracking-wider font-bold border-b border-gray-100">
                            <tr>
                                ...
                                <th className="p-5">السقف (ل.س)</th>
                                <th className="p-5">الفئة الوظيفية المرتبطة</th>
                                ...
                                <tr>
                                    <td colSpan={4} className="p-16 text-center text-gray-500">
                                        <div className="flex flex-col items-center">
                                            ...
                                            <span className="text-sm">لم يتم إدخال سقوف أجور بعد.</span>
                                        </div>
                                    </td>
                                </tr>
                            )}
